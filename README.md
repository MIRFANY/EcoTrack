...
// User logs:
const dailyActivity = {
  transportation: { type: 'bus', distance: 20 },    // 1.78 kg
  meals: [
    { type: 'vegan', count: 1 },                    // 1.5 kg
    { type: 'fish', count: 1 }                      // 3.5 kg
  ],
  digitalWaste: { emails: 100, streamingHours: 2 } // 0.4 + 0.072 = 0.472 kg
}

// Calculated emissions:
Total = 1.78 + 1.5 + 3.5 + 0.472 = 7.752 kg CO₂e
Score = max(0, 100 - (7.752/25)*100) = 69 points
```
...
- ⚠️ TODO: Add input validation (express-validator)
...
- [ ] Team challenges
- [ ] Integration with universities' sustainability office
